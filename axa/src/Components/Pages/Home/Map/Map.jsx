...
import MapData from './Mapmockdata';

const Map = () => {
  const [Mapdescription, setMapdescription] = useState(false);
// const location = document.querySelectorAll(".map");
  ...
  return (
   <section id='map'>
    <div className="maps_container">
     ...
     {
      Mapdescription&&Mapdescription.map((e)=>(
        <div className="map_description">
        <h4>{e.LocationName}</h4>
        <p id='name'>{e.FullName}</p>
        <p id='tel'>Tel:{e.Tel}</p>
        <p id='ip'>Ip:{e.Ip}</p>
        <p id='email'>E:{e.Email}</p>
        <p id='location'>{e.Location}</p>
